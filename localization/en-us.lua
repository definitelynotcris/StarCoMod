...
<<<<<<< HEAD
            ...
            j_star_d20_0         = { 
                name = 'D20',
                text = {
                    "Press {C:green}[C]{} to cycle description (1/3)",
                    " ",
                    "Before scoring, rolls for",
                    "{C:attention}1{} of {C:attention}20{} random effects",
                    "Roll is unaffected by {C:green}luck{}",
                    "{C:green}+#1# luck{}",
                    "{C:inactive}(ex: {}{C:green}2 in 4{}{C:inactive} -> {}{C:green}3 in 4{}{C:inactive})",
                    "Last roll: {C:attention}#2#{}"
                },
            },
            j_star_d20_1         = { 
                name = 'D20',
                text = {
                    "Press {C:green}[C]{} to cycle description (2/3)",
                    " ",
                    "{C:attention}1.{} Explodes",
                    "{C:attention}2.{} Debuffs a random Joker for this hand",
                    "{C:attention}3.{} -1 hand or -1 discard until round end",
                    "{C:attention}4.{} Destroys 3 random cards held in hand",
                    "{C:attention}5.{} -1 hand size until round end",
                    "{C:attention}6.{} Increase or decrease a random hand's level by 2",
                    "{C:attention}7.{} Multiply this blind's required score by 1.5",
                    "{C:attention}8.{} Reshuffles all Jokers",
                    "{C:attention}9.{} +1 luck, diminishes by 0.25 on round end", 
                    "{C:attention}10.{} Nothing happens ", 
                },
            },
            j_star_d20_2         = { 
                name = 'D20',
                text = {
                    "Press {C:green}[C]{} to cycle description (3/3)",
                    " ",
                    "{C:attention}11.{} Creates 2 random Skip Tags",
                    "{C:attention}12.{} Disables the Boss Blind, if there is one",
                    "{C:attention}13.{} Multiply this blind's required score by 0.5",
                    "{C:attention}14.{} Copies the ability of the leftmost Joker",
                    "{C:attention}15.{} Enhances all played cards with no enhancement into Lucky Cards",
                    "{C:attention}16.{} Gain +5 hand size next hand",
                    "{C:attention}17.{} Win $20", 
                    "{C:attention}18.{} Retrigger all played cards twice",
                    "{C:attention}19.{} Regenerate either all hands or all discards", 
                    "{C:attention}20.{} Permanently gain either +1 hand, +1 discard, +1 hand size,",
