...
function create_UIBox_custom_video1(name, buttonname)
  local file_path = SMODS.Mods["StarCoMod"].path.."/resources/"..name..".ogv"
  ...
  local t = create_UIBox_generic_options({ back_delay = 28 , back_label = buttonname, colour = G.C.BLACK, padding = 0, contents = {
